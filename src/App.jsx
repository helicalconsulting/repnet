...
import { PanelLeftOpen, Sun, Moon, Bell, X } from 'lucide-react'
...
function AppContent() {
  ...
  const isFocusMode = (activeView === 'chat' && chatState === 'landing') || (activeView === 'chat' && chatState === 'conversation');
    ...
    <div className={`flex h-screen w-full transition-colors duration-700 bg-[var(--background)] overflow-hidden relative`}>
      ...
      <div className="absolute top-0 left-0 w-full p-6 flex justify-between items-center z-40 pointer-events-none">
        ...
        <div className="pointer-events-auto flex items-center gap-3">
           ...
           {/* User Avatar */}
           <div className="w-9 h-9 rounded-xl border border-black/10 dark:border-white/10 bg-gradient-to-br from-primary to-blue-600 flex items-center justify-center text-sm font-bold cursor-pointer transition-all hover:scale-105 text-white shadow-lg shadow-primary/20">
             K
           </div>
        </div>
      </div>
